...
echo "# Github: https://github.com/uncia/shadowsocksr_install     #"
echo "#############################################################"
echo
...
install(){
    ...
    if [ -f /usr/bin/ssserver ] || [ -f /usr/local/bin/ssserver ]; then
        ...
        echo
        echo -e "[${red}Error${plain}] Shadowsocks install failed! please visit https://github.com/uncia/shadowsocksr_install and contact."
        install_cleanup
        exit 1
    fi
